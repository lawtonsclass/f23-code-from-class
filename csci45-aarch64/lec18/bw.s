...
loop:
  ...
  // read a chunk of pixels (only into the left half of v registers
  // because doing it with full v registers is more complicated)
  ld3 {v0.8B, v1.8B, v2.8B}, [x0]
  // .8B means read into the left half of each register

  // process them

  // extend blue
  uxtl v3.8H, v0.8B // really just working on the left half again here
  // extend green
  uxtl v4.8H, v1.8B
  // extend red
  uxtl v5.8H, v2.8B
  ...
  mov v0.8B, v3.8B // left half of v0 holds red
  mov v1.8B, v0.8B // left half of v1 holds green
  mov v2.8B, v0.8B // left half of v2 holds blue

  // write them back to memory
  st3 {v0.8B, v1.8B, v2.8B}, [x0] // we're really writing just the left halves of v0, v1, & v2
